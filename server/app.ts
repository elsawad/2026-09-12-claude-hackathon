...
// the upload handler below only writes here when USE_BLOB is false.
try {
...
// serverless instances — an accepted limitation for a demo, not a
// correctness issue for anything else in the pipeline.
